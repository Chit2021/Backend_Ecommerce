...
router.post("/", validateOrderDetail, OrderDetailController.createOneOrderDetail);
router.put("/:orderDetailId", validateOrderDetail, OrderDetailController.findOneAndUpdate);
